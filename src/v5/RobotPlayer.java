            ...
            try {
                ...
                if (!rc.isSpawned()){
                    ...
                    if (rc.hasFlag() && rc.getRoundNum() >= GameConstants.SETUP_ROUNDS){
                        ...
                        Pathing.moveTowardsFlee(rc, firstLoc, 13);
                        rc.setIndicatorString("Fleeing with Flag towards " + firstLoc.toString());
                        continue;
                    }
                    ...
                    if (closeFlags.length > 0)
                    {
                        ...
                        rc.setIndicatorString("Grabbing Close Flag at " + target.toString());
                    }
                    else
                    {
                        ...
                        {
                            target = enemyFlags[0];
                            rc.setIndicatorString("" + enemyFlags.length + "Grabbing Flag at " + target.toString());
                        }
                        else
                        {
                            //Go to the opposite location of the spawn
                            target = Exploration.getExploreTarget(rc);
                            rc.setIndicatorString("" + enemyFlags.length + "Exploring " + target.toString());
                        }
                    }
                    ...
                    MapLocation prevLoc = rc.getLocation().subtract(moveDir);

...
public class Constants {
    ...
    public static final int FLAG_DEFENSE_IDX = CLUSTER_POINT_IDX + Constants.NUM_CLUSTER_POINTS;
    public static final int DISTRESS_IDX = FLAG_DEFENSE_IDX + GameConstants.NUMBER_FLAGS;

...
public class PathFinder {
    ...
    public static void retreatFrom(MapLocation fleeFrom) throws GameActionException {
        if (!SharedVariables.rc.isMovementReady()) return;

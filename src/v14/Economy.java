...
public class Economy {
    ...
    public static int getCrumbsForDefense(RobotController rc, MapLocation base) throws GameActionException {
        ...
        {
            if (friendlyFlags[i].equals(base))
            {
    ...
    public static void printBudgets(RobotController rc) throws GameActionException {
        ...
        for (int i = 0; i < friendlyFlags.length; i++)
        {
            System.out.println("Defense Budget for Flag " + friendlyFlags[i] + " = " + getCrumbsForDefense(rc, friendlyFlags[i]));
        ...
        for (int i = 0; i < friendlyFlags.length; i++)
        {
            System.out.println("Defense Crumbs Spent for Flag " + friendlyFlags[i] + " = " + Communication.getCrumbsSpentDefense(rc, friendlyFlags[i]));
        }

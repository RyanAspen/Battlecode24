    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                SharedVariables.verbose = (rc.getID() == 11136 && rc.getRoundNum() >= 248 && rc.getRoundNum() <= 250);
                if (SharedVariables.verbose)
                {
                    System.out.println("Role = " + SharedVariables.currentRole);
                }
                if (!rc.isSpawned()){
                    ...
                    if (SharedVariables.currentRole != null) {
                        switch (SharedVariables.currentRole) {
                            ...
                            case Defender:
                                if (SharedVariables.verbose)
                                {
                                    System.out.println("Running Defender. Movement Available = " + rc.isMovementReady());
                                }
